========================================================================
    KONSOLENANWENDUNG: watcherService-Projektübersicht
========================================================================

Diese watcherService-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre watcherService-Anwendung besteht.


watcherService.vcxproj
...
watcherService.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen watcherService.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
